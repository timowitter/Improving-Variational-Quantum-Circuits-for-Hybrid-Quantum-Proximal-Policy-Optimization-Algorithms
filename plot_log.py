...
max_steps = 25000
alpha = 0.3
labels=["NN(3)-(67-Param)", "NN(4)-(88-Param)", "NN(5)-(109-Param)", "NN(4,4)-(108-Param)", "NN(64,64)-(5508-Param)", "random-baseline"]
...
max_steps = 150000
alpha = 0.3
labels=["Lr=0.5e-3", "Lr=2.5e-3", "Lr=5.0e-3", "Lr=10.0e-3", "random-baseline"]
...
max_steps = 150000
alpha = 0.3
labels=["QPPO-Critic-Lr(0.5e-4)", "QPPO-Critic-Lr(2.5e-4)", "QPPO-Critic-Lr(5.0e-4)", "QPPO-Critic-Lr(10.0e-4)", "random-baseline"]
...
max_steps = 150000
alpha = 0.3
labels=["Lr=(10->0.1)e-3, HWZ=15000", "Lr=(10->0.1)e-3, HWZ=25000", "Lr=(10->0.1)e-3, HWZ=40000", "Lr=(10->1.0)e-3, HWZ=10000", "Lr=(10->1.0)e-3, HWZ=20000", "Lr=(10->1.0)e-3, HWZ=35000", "random-baseline", "Konst-Lr=2.5e-3"]
...
max_steps = 50000
alpha = 0.3
labels=["Standard-Init", "Kleine-Init", "Mittlere-Init", "Große-Init", "Gauß-Init", "random-baseline"]
...
max_steps = 100000
alpha = 0.3
labels=["globalesOutScale(1e-3) (73-Param)", "globalesOutScale(1e-2) (73-Param)", "LokalesOutScale(1e-3) (76-Param)", "LokalesOutScale(1e-2) (76-Param)", "LokalesOutScale(5e-2) (76-Param)", "random-baseline", "keinOutScale (72-Param)"]
...
max_steps = 25000
alpha = 0.3
labels=["QPPO-globalesOutScale(1e-2)-(73-Param)", "QPPO-lokalesOutScale(1e-2)-(76-Param)", "QPPO-lokalesOutScale(5e-2)-(76-Param)", "random-baseline", "PPO(3)-(67-Param)", "PPO(4)-(88-Param)"]
...
max_steps = 150000
alpha = 0.3
labels=["globalesOutScale(1e-4)", "globalesOutScale(1e-3)", "globalesOutScale(1e-2)", "globalesOutScale(5e-2)", "globalesOutScale(1e-1)", "random-baseline"]
...
max_steps = 150000
alpha = 0.3
labels=["LokalesOutScale(1e-4)", "LokalesOutScale(1e-3)", "LokalesOutScale(1e-2)", "LokalesOutScale(5e-2)", "LokalesOutScale(1e-1)", "random-baseline"]
...
max_steps = 150000
alpha = 0.3
labels=["Data-Reuploading-(5e-3)", "Data-Reuploading-(1e-3)", "kein-Reuploading-(5e-3)", "kein-Reuploading-(1e-3)", "random-baseline"]
...
max_steps = 50000
alpha = 0.3
labels=["QPPO-Std-(73-params)", "QPPO-HgogVQC-(73-params)", "QPPO-JerbiVQC-(73-params)", "random-baseline", "PPO(3)-(67-params)", "PPO(4)-(88-params)"]
...
max_steps = 150000
alpha = 0.3
labels=["QPPO-all-methods-(73-params)", "QPPO-no-reuploading-(73-params)", "QPPO-no-OutScale-(72-params)", "QPPO-no-exp-lr-(73-params)", "random-baseline", "PPO(3)-(67-params)", "PPO(4)-(88-params)"]
...
max_steps = 25000
alpha = 0.3
labels=["QPPO-global-OutScale-(76-params)", "random-baseline", "PPO(3)-(67-params)", "PPO(4)-(88-params)"]
...
max_steps = 500000
alpha = 0.05
labels=["Lr=5.0e-5", "Lr=1.0e-4", "Lr=2.5e-4", "Lr=1.0e-3", "random-baseline"]
...
max_steps = 500000
alpha = 0.05
labels=["NN(5,5)-(67-Param)", "NN(6,5)-(77-Param)", "NN(6,6)-(86-Param)", "NN(7,7)-(107-Param)", "NN(64,64)-(4610-Param)", "random-baseline"]
...
max_steps = 500000
alpha = 0.05
labels=["NN(5,5)-Sigmoid-Lr-(67-Param)", "NN(6,5)-Sigmoid-Lr-(77-Param)", "NN(6,6)-Sigmoid-Lr-(86-Param)", "NN(7,7)-Sigmoid-Lr-(107-Param)", "NN(64,64)-Sigmoid-Lr-(4610-Param)", "random-baseline"]
...
max_steps = 500000
alpha = 0.05
labels=["Fixe-Lr", "Exp-Lr", "Sigmoid-Lr", "random-baseline"]
...
max_steps = 500000
alpha = 0.05
labels=["QPPO Lr=2.5e-3", "QPPO Lr=1.0e-2", "QPPO Lr=(10->0.1)e-3, HWZ=15000", "QPPO Lr=(10->0.1)e-3, HWZ=25000", "QPPO Lr=(10->0.1)e-3, HWZ=35000",  "random-baseline", "PPO(5,5) Lr=1.0e-4"]
...
max_steps = 150000
alpha = 0.05
labels=["QPPO Lr=0.5e-3", "QPPO Lr=2.5e-3", "QPPO Lr=1.0e-2", "QPPO Lr=5.0e-2", "random-baseline", "PPO(5,5) Lr=1.0e-4"]
...
max_steps = 500000
alpha = 0.05
labels=["OutScale(1e-5)", "OutScale(1e-4)", "OutScale(1e-3)", "OutScale(1e-2)", "OutScale(1e-1)", "random-baseline", "keinOutScale"]
...
max_steps = 500000
alpha = 0.05
labels=["QPPO-Lr(2.5e-3)-OutScale(1e-4)-Zirkuläre-LV", "QPPO-Lr(2.5e-3)-OutScale(1e-3)-Zirkuläre-LV", "QPPO-Lr(5.0e-3)-OutScale(1e-3)-Zirkuläre-LV", "QPPO-Lr(2.5e-3)-OutScale(1e-4)", "QPPO-Lr(2.5e-3)-OutScale(1e-3)", "QPPO-Lr(5.0e-3)-OutScale(1e-3)", "random-baseline"]
...
max_steps = 150000
alpha = 0.05
labels=["Standard-Init", "Kleine-Init", "Mittlere-Init", "Große-Init", "random-baseline"]
...
max_steps = 150000
alpha = 0.05
labels=["Standard-Init", "Gauß-Init", "Clipped-Gauß-Init", "random-baseline"]
...
max_steps = 500000
alpha = 0.05
labels=["Standard-Init", "Clipped-Gauß-Init", "Kleine-Init", "random-baseline"]
...
max_steps = 500000
alpha = 0.05
labels=["Konst-Lr=0.5e-3", "Konst-Lr=2.5e-3", "Konst-Lr=10e-3", "Exp-Lr=(10->0.1)e-3, HWZ= 75000", "Exp-Lr=(2.5->0.1)e-3, HWZ=100000", "Exp-Lr=(2.5->0.1)e-3, HWZ=150000", "random-baseline"]
...
max_steps = 150000
alpha = 0.05
labels=["pi*tanh(x)-Reskalierung", "pi*tanh(2x)-Reskalierung", "2pi*arctan(x)-Reskalierung", "2pi*arctan(2x)-Reskalierung" , "random-baseline"]
...
max_steps = 150000
alpha = 0.05
labels=["QPPO(4-Layer)-InpScale-Lr=(2.5->0.1)e-3,HWZ=100000-(65-Param)", "QPPO(5-Layer)-InpScale-Lr=(2.5->0.1)e-3,HWZ=100000-(81-Param)", "QPPO(5-Layer)-InpScale-Lr=(2.5->0.1)e-3,HWZ=_80000-(81-Param)", "QPPO(6-Layer)-InpScale-Lr=(2.5->0.1)e-3,HWZ=100000-(97-Param)", "QPPO(6-Layer)-InpScale-Lr=(1.5->0.1)e-3,HWZ=100000-(97-Param)", "random-baseline", "QPPO-manuelles-Rescale-Lr=(2.5->0.1)e-3,HWZ=100000-(73-Param)", "QPPO-globales-InpScale-Lr=(2.5->0.1)e-3,HWZ=100000-(77-Param)"]
plot_test_avg_final(results_dir, plot_dir, gym_id, exp_names, seeds, alpha, max_steps, labels)
...
max_steps = 500000
alpha = 0.015
labels=["QPPO-manuelles-Rescale-(73-Param)", "QPPO-globales-InpScale-(77-Param)", "QPPO(5-Layer)-InpScale-(81-Param)", "random-baseline", "PPO(5,5)-(67-Param)", "PPO(6,5)-(77-Param)", "PPO(6,6)-(86-Param)"]
...
max_steps = 500000
alpha = 0.015
labels=["QPPO-manual-ReScale-(73-params)", "QPPO-global-InpScale-(77-params)", "QPPO(4-layer)-InpScale-(65-params)", "QPPO(5-layer)-InpScale-(81-params)", "random-baseline", "PPO(5,5)-(67-params)", "PPO(6,5)-(77-params)"]
