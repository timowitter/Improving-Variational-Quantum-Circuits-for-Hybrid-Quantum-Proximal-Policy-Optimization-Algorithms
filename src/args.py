...
def parse_args():
    ...
    parser.add_argument('--cuda', type=lambda x:bool(strtobool(x)), default=True, nargs='?', const=True, help='determines if gpu shall be used /default:True')
    ...
    parser.add_argument('--quantum-critic', type=lambda x:bool(strtobool(x)), default=True, nargs='?', const=True, help='if True quantum critic will be used')
