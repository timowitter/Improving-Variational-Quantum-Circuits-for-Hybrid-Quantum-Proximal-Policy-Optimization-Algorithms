...
def avg_episode_results_of_update(episode_results_df, gym_id, exp_name, seed, stepsize, max_steps):
    ...
    for i in range(stepsize, max_steps, stepsize):
        df_tmp = episode_results_df[(episode_results_df.global_step <= i) & (episode_results_df.global_step > (i-stepsize))]
...
def plot_training_results(results_dir, plot_dir, gym_id, exp_name, circuit, seed, stepsize, max_steps):
    ...
    avg_episode_results = avg_episode_results_of_update(episode_results, gym_id, exp_name, seed, stepsize, max_steps)
...
def plot_avg_episode_reward_by_exp_name(episode_results, dir):
    sns.relplot(
    data=episode_results, kind="line",
    x="global_step", y="avg_rewards", col="gym_id",
...
def plot_avg_episode_length_by_exp_name(episode_results, dir):
    sns.relplot(
    data=episode_results, kind="line",
    x="global_step", y="avg_lengths", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_learning_rate_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="learning_rate", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_qlearning_rate_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="qlearning_rate", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_value_loss_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="value_loss", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_policy_loss_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="policy_loss", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_entropy_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="entropy", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_loss_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="loss", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_SPS_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="SPS", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_output_scaleing_by_exp_name(update_results, dir):
    sns.relplot(
    data=update_results, kind="line",
    x="global_step", y="output_scaleing", col="gym_id",
    hue="exp_name", style="exp_name",
    )
...
def plot_test_avg(results_dir, plot_dir, gym_id, exp_names, seeds, stepsize, max_steps):
    ...
    #load dataframes
    ep_res_df_list = [pd.read_csv(os.path.join(loc, 'episode_results.csv')) for loc in results_dirs] 
    ...
    ep_res_avg_list = [avg_episode_results_of_update(df, gym_id, exp_name, seed, stepsize, max_steps) for df, seed, exp_name in zip(ep_res_df_list, dir_seeds, dir_exp_names)]
    #concat dataframes
    ...
    ep_res_avg = avg_episode_results_of_update_by_exp_name(ep_res, gym_id, exp_names, stepsize, max_steps)
